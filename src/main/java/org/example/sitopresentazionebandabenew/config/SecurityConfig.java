    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/messages").permitAll() // Form contatti pubblico
                // ---- Contenuti pubblici (sola lettura) ----
                .requestMatchers(HttpMethod.GET, "/api/public/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/gallery/public/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/gallery/photos/**").permitAll() // Serve immagini/thumbnail
                ...
                .requestMatchers("/api/auth/me", "/api/auth/logout",
                                 "/api/auth/profile", "/api/auth/change-password").authenticated()
