...
public class ActivityLogController {
    ...
    public ResponseEntity<Page<ActivityLogResponse>> getAllActivity(
            @RequestParam(required = false) TargetType targetType, @PageableDefault(size = 50) Pageable pageable) {
    ...
    @GetMapping("/recent")
    public ResponseEntity<List<ActivityLogResponse>> getRecentActivity(@RequestParam(defaultValue = "24") int hours) {
